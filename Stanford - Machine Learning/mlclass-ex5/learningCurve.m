...
for i = 1:m,
	...
	% get the cost
	[error_train(i,1), grad] = linearRegCostFunction(xSubset, ySubset, theta, 0);
	
	% validate well my friend~
	% xSubset = X(n+1:m, :);
	% ySubset = y(n+1:m);
	%[error_val(i,1), grad] = linearRegCostFunction(xSubset, ySubset, theta, 0);

...
<ul>
  ...
  <li> Text can be <b>bold(B)</b>, <i>italic(I)</i> <small>small(SMALL)</small>, <big>big (BIG)</big>, or look like a <tt>typewritter (TT)</tt></li>
  <li> There are also ordered lists that use (OL) tag. Let's make one nested inside our current list item.
	  <ol>
  ...
  <li> It is also possible to include image <img src='cs262.png'/>(IMG SRC="cs262.png")</li>
